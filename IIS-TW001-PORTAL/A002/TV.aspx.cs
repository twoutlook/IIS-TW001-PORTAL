...
public partial class TV : System.Web.UI.Page
{
    ...
    public static string DBConnection()
    {
        try
        {
            return System.Configuration.ConfigurationManager.AppSettings["connstring2"];
...
";
    ...
    public string GetHtmlTable(string strSQL)
    {
        ...
        string dbConnection = System.Configuration.ConfigurationManager.ConnectionStrings["connstring2"].ConnectionString;
        SqlConnection thisConnection = new SqlConnection(dbConnection);
        SqlCommand thisCommand = thisConnection.CreateCommand();
        //        thisCommand.CommandText = "SELECT * from V_A001";
